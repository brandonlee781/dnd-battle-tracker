...
export type IUseState = Mapper<Computed> &
  MapperWithNamespace<Computed> &
  MapperForState &
  MapperForStateWithNamespace

export type IUseGetters = Mapper<Computed> & MapperWithNamespace<Computed>

export type IUseMutations = Mapper<MutationMethod> &
  MapperWithNamespace<MutationMethod> &
  FunctionMapper<Commit, MutationMethod> &
  FunctionMapperWithNamespace<Commit, MutationMethod>

export type IUseActions = Mapper<ActionMethod> &
